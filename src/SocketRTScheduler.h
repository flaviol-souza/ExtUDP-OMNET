...
#ifndef __EXTUDP_OMNET_CSOCKETRTSCHEDULER_H__
#define __EXTUDP_OMNET_CSOCKETRTSCHEDULER_H__
 ...
 * a single UDP socket: maybe UDP socket, maybe raw socket to grab full Ethernet
...
class cSocketRTScheduler : public cScheduler
{
  protected:
    ...
    sockaddr_in clientAddr; // Store the last sender address
    socklen_t addrLen;
